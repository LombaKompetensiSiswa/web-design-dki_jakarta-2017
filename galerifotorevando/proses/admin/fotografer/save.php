...
$insert_mapping = $koneksi->prepare('insert into fotografer(id,nama,foto,biodata,user_id) values("","'.$nama.'","'.$file.'","'.$biodata.'","'.$data_last_user['id'].'")');
$insert_mapping->execute();

header('Location:../../../dashboard.php?p=fotografer');
?>
