  ...
  <div class="container">
    <div class="row area center">
      ...
      <form method="POST" action="" enctype="multipart/form-data">
        ...
        <input class="form-box" type="text" name="level" value="" placeholder="admin/kurator/member" required>
...
$i=$_POST;
  ...
  if(isset($i['submit']) ){
        ...
        if(!$photo){
          $insert = "INSERT INTO tb_users(name,username, password,photoProfile,biodata,level) VALUES('$name','$username','$password','$photo','$biodata','$level') ";
