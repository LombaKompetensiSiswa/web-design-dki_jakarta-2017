<section id="login">
  <div class="container">
    <div class="row area center">
      ...
      <a href="index.php?" style="text-align:center; display:block; margin-top:20px;">Back to Home</a>
    </div>
  </div>
</section>
...
$i=$_POST;
  if(isset($i['login'])){
    ...
    $query = "SELECT * FROM tb_users WHERE username='$username' && password = '$password'";
