...
<section id="gallery" style="padding-top:100px;">
  <div class="container">
    <div class="row">
      ...
      <div class="col-12">
        <h1 class="master-title">Karya Saya</h1>
        <p class="main-title-desc"><b>Berikut adalah foto yang telah saya upload.</b></p>
     ...
     <?php
       $query2 ="SELECT * FROM tb_photo WHERE id_user ='$id' ";
